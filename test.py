...
class TestSimulation(unittest.TestCase):
    ...
    def test_generateCars(self):
        ...
        self.assertTrue(len(simulator.northLane)>0 or len(simulator.southLane) > 0 or len(simulator.eastLane) > 0 or len(simulator.westLane) > 0)
        self.assertEqual((len(simulator.northLane)+len(simulator.southLane)+len(simulator.eastLane)+len(simulator.westLane)),10)
    ...
    def test_displayCars(self):
        ...
        self.assertEqual(capturedOutput.getvalue(),"NORTH: " + str(simulator.northLane) + "\nEAST: " + str(simulator.eastLane) + "\nSOUTH: " + str(simulator.southLane) + "\nWEST: " + str(simulator.westLane) + "\n")
    ...
    def test_timer(self):
        ...
        simulator.timer()
        sys.stdout = sys.__stdout__
        self.assertEqual(capturedOutput.getvalue(),"----------\nTIME ELAPSED: 00:00:00 | Total cars: " + str(simulator.all_cars) + "\n")
    ...
    def test_TLAttr(self):
        ...
        self.assertEqual(trafficLight.whatsOn(),[True,True,False,False,False,False])
